            ...
            <div class="content-wrapper">
                ...
                <div id="menu_status">
                    ...
                    <ul class="nav nav-pills">
                              ...
                              <li role="presentation" style="width:30%"><a href="#">ส่วนที่2 ความจำเป็นในการพัฒนา</a></li>
                              <li role="presentation" class="active" style="width:30%"><a href="#">การประเมินเรียบร้อย</a></li>
                    </ul>
                    </center>
                </div>
