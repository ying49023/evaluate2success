                            ...
                            <div class="col-md-offset-1 col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="prefix"  disabled="true">
                                    ...
                                    <div class="col-md-4">                                                
                                        <div class="form-group">
                                            <label>ชื่อ</label>
                                            <input class="form-control" name="first_name" type="text" value="<?php echo $f_name; ?>"  disabled="true">
                                        </div>                                                
                                    </div>
                                    <div class="col-md-6">                                                
                                        <div class="form-group">
                                            <label>นามสกุล</label>
                                            <input class="form-control" name="last_name" type="text" value="<?php echo $l_name; ?>"  disabled="true">
                                        </div>                                               
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">                                               
                                        <div class="form-group">
                                            <label>แผนก</label>
                                            <select class="form-control" name="department"  disabled="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">                                                
                                        <div class="form-group">
                                            <label>ตำแหน่ง</label>
                                            <select class="form-control" name="job_id"  disabled="true">
                                    ...
                                    <div class="col-md-6">                                                
                                        <div class="form-group">
                                            <label>ระดับ </label>
                                            <select class="form-control" name="position_level_id"  disabled="true">
