                ...
                <div id="menu_status">
                    <center>
                        <ul class="nav nav-pills">
                            ...
                            <li role="presentation" class="bg-info  " style="width:30%"><a href="#">Step II</a></li>
                            <li role="presentation" class="bg-info" style="width:30%"><a href="#">Comfirm Form</a></li>
                        </ul>
                    </center>
                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div id="detail-content">
                                        ...
                                        <TABLE " HEIGHT="120" WIDTH="90%"  >
                                            ...
                                            <TR>
                                                <TD><b>ครึ่งปีแรก(ม.ค.-มิ.ย.)</b></TD><TD colspan="2"><span class="text-green">ประเมินแล้ว</span></TD>
